...
if __name__ == '__main__':
    # process_eurosat(
    #     src_dir="/data1/common_datasets/vision_cls/_temp/2750",
    #     dst_dir="/data1/common_datasets/vision_cls//EuroSAT_splits")
    # process_dtd(
    #     source_dir="/data1/common_datasets/vision_cls/_temp",
